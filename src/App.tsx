...
import { generateReaderStatsPDF, generateGlobalStatsPDF, generatePlanningPDF } from './lib/reports';
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-32">
            {masses.map(mass => {
              const planning = plannings[mass.id];
              return (
                <Card key={mass.id} className="p-8 space-y-6 bg-slate-900/30 border-slate-800/50">
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
